...
const root=new URL('../../../../',import.meta.url), out=new URL('assets/source/western/contact-v2/',root);
...
for(const kind of ['lion','wolf','unicorn']) {
 const bytes=await fs.readFile(new URL(`assets/source/western/contact-v2/candidate/${kind}-upright.glb`,root));
 const source=await fs.readFile(new URL(`assets/source/western/contact-v2/candidate/${kind}-upright.blend`,root));
