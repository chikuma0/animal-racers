/** Frozen Cycle5 structural oracle; only isolated input/output paths adapted for Cycle6. */
...
const root=new URL('../../../../../',import.meta.url), out=new URL('assets/source/western/contact-v2/v2b/',root);
...
for(const kind of ['lion','wolf','unicorn']) {
 const bytes=await fs.readFile(new URL(`assets/source/western/contact-v2/v2b/candidate/${kind}-upright.glb`,root));
 const source=await fs.readFile(new URL(`assets/source/western/contact-v2/v2b/candidate/${kind}-upright.blend`,root));
